    ...
    <div class="navbar-content">
      ...
      <ul class="pc-navbar">
        ...
        <li class="pc-item <?= ($current_page == 'bimbingan.php') ? 'active' : '' ?>">
          <a href="<?= $asset_prefix ?>dosen/bimbingan.php" class="pc-link">
        ...
        <li class="pc-item <?= ($current_page == 'laporan_mhs.php') ? 'active' : '' ?>">
          <a href="<?= $asset_prefix ?>dosen/laporan_mhs.php" class="pc-link">
        ...
        <li class="pc-item <?= ($current_page == 'presensi_mhs.php') ? 'active' : '' ?>">
          <a href="<?= $asset_prefix ?>dosen/presensi_mhs.php" class="pc-link">
        ...
        <li class="pc-item <?= ($current_page == 'penilaian_mingguan.php') ? 'active' : '' ?>">
          <a href="<?= $asset_prefix ?>dosen/penilaian_mingguan.php" class="pc-link">
        ...
        <li class="pc-item <?= ($current_page == 'penilaian_akhir.php') ? 'active' : '' ?>">
          <a href="<?= $asset_prefix ?>dosen/penilaian_akhir.php" class="pc-link">
        ...
        <li class="pc-item <?= ($current_page == 'dokumen_akhir_mhs.php') ? 'active' : '' ?>">
          <a href="<?= $asset_prefix ?>dosen/dokumen_akhir_mhs.php" class="pc-link">
        ...
        <li class="pc-item <?= ($current_page == 'monitoring.php') ? 'active' : '' ?>">
          <a href="<?= $asset_prefix ?>dosen/monitoring.php" class="pc-link">
        ...
        <li class="pc-item <?= ($current_page == 'pengumuman.php') ? 'active' : '' ?>">
          <a href="<?= $asset_prefix ?>dosen/pengumuman.php" class="pc-link">
